...
// nodejs에서는 모듈은 각각의 파일 스코프를 가지기 때문에 this는 모듈 자체를
// 가르키게 된다.
...
// global.console.timeEnd() // 코드 종료 후 시간 출력 해당 끝낼 테스트 이름을 문자열로 작성

// 전달된 객체를 표 형태로 보여주는 메소드
// global.console.table({a : { name : "안녕"},b : { name : "안뇽2"},c : { name : "안뇽3"}})
