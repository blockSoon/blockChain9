// http 요청과 응답을 좀더 편하게 사용할수 있도록 도와주는 모듈
// express nodejs에서 제일 인기가 많은 모듈
// nodejs 프레임워크
// http요청과 응답을 더 쉽게 작성할수 있도록 도와준다.
// 기본적인 기능만 포함하고있어서.
// 자유도 높고 라우팅 미들웨어 등등 개발자가 원하는 방식으로
// 구성할수 있다.
// 본인만의 보일러 플레이팅이 가능하다.
// 보일러 플레이팅은 반복복인 작업을 피할수 있도록
// 미리 개발자가 작성을 하고 개발의 생산성을 향상 시킬수있다.
// express를 사용해보자 일단.
...
// 예 ) dev 가정하면 npm run dev 이렇게 실행 하면된다.