...
// Content-length : 전송되는 데이터의 길이 데이터의 끝을 알려주는 역활을 한다. 

// 서버 객체 생성
const server = net.createServer((client)=>{
    // 클라이언트가 접속시 실행
    // 인코딩 설정
    // setEncoding 메서드로 인코딩 방식을 설정 할수 있다.
